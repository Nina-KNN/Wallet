...
public class BalanceListCategorySortAdapter extends BaseRecyclerAdapter<Balance> {

    private BaseRecyclerAdapter.OnItemClick<Balance> itemListener;

    protected BalanceListCategorySortAdapter(BaseActivity baseActivity, List<Balance> items, OnItemClick<Balance> onItemClick) {
