...
public class BalanceListDateSortInnerAdapter extends BaseRecyclerAdapter<Balance> {
    private BaseRecyclerAdapter.OnItemClick<Balance> itemListener;

    protected BalanceListDateSortInnerAdapter(BaseActivity baseActivity, List<Balance> items, OnItemClick<Balance> onItemClick) {
