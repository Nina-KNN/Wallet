...
public class BalanceListDateSortInnerAdapter extends BaseRecyclerAdapter<GregorianCalendar> {
    ...
    public BalanceListDateSortInnerAdapter(BaseActivity baseActivity, List<GregorianCalendar> items, OnItemClick<GregorianCalendar> onItemClick) {
    ...
    private void makeRecyclerView(List<Balance> balanceList) {
        adapter = new BalanceListDateSortAdapter((BaseActivity) context, balanceList, innerItemListener);
